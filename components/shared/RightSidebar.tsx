...
const RightSidebar = () => {
  const hotQuestions = [
    ...
    { _id: "2", title: "How to use the new Next.js Image component?" },
    {
      _id: 3,
      title:
        "What is the difference between getStaticProps and getServerSideProps in Next.js?",
    },
    { _id: "4", title: "How to add a new page in Next.js?" },
    { _id: "5", title: "How to use the new Next.js Image component?" },
  ];
  ...
  const popularTags = [
    ...
    { _id: "4", name: "typescript", totalQuestions: 25 },
    { _id: "5", name: "tailwindcss", totalQuestions: 15 },
  ];
  return (
    <section
